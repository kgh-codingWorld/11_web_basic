...
SELECT EMP_NO , NAME , COMM FROM EMP WHERE COMM NOT IN(300, 500, 1400);

# 15) 이름에 S가 포함되지 않는 사원의 사번,이름을 조회하시오.
SELECT EMP_NO , NAME FROM EMP WHERE NAME NOT LIKE '%S%';
...
SELECT EMP_NO , NAME , SALARY FROM EMP ORDER BY SALARY DESC, NAME ASC;
...
DELETE FROM EMP 
WHERE DEPT_NO IN(7900,7902,7934);
